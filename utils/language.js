...
// const { default: data } = await import("./content.json", { assert: { type: "json" } })
...
//    document.getElementById("survey-pl").innerText = data[language]["survey-pl"];
//    document.getElementById("survey-en").innerText = data[language]["survey-en"];
